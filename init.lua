...
-- Keybinding for horizontal terminal split
...
require('lazy').setup({
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      vim.api.nvim_set_hl(0, 'VertSplit', { fg = '#C8C8C8', bg = 'none' })
      vim.api.nvim_set_hl(0, 'HorizSplit', { fg = '#C8C8C8', bg = 'none' })
    end,
  },
